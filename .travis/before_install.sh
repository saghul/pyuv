...
if [[ $TRAVIS_PYTHON_VERSION == 'pypy' ]]; then
    ...
    cd pypy-5.7-linux_x86_64-portable

    echo 'Setting up aliases...'
    export PATH=$HOME/pypy-5.7-linux_x86_64-portable/bin/:$PATH
    ln -s ~/pypy-5.7-linux_x86_64-portable/bin/pypy bin/python
...
if [[ $TRAVIS_PYTHON_VERSION == 'pypy3' ]]; then
    ...
    cd pypy3.5-5.7-beta-linux_x86_64-portable

    echo 'Setting up aliases...'
    export PATH=$HOME/pypy3.5-5.7-beta-linux_x86_64-portable/bin/:$PATH
    ln -s ~/pypy3.5-5.7-beta-linux_x86_64-portable/bin/pypy3.5 bin/python

    echo 'Setting up pip...'
    bin/pypy -m ensurepip
    ln -s ~/pypy3.5-5.7-beta-linux_x86_64-portable/bin/pip3.5 bin/pip
fi
